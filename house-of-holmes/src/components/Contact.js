...
const Contact = () => {
  ...
  return (
    <section id="contact" className="contact-info">
      ...
      <p><strong>{t('contact.phone')}:</strong> <a href="tel:+14809691771">(480) 969-1771</a></p>
      <p><strong>{t('contact.email')}:</strong> <a href="mailto:contact@houseofholmes.com">contact@houseofholmes.com</a></p>
      
      {/* Social Media Links */}
      <div className="contact-social">
        <h3>{t('contact.connectWithUs')}</h3>
